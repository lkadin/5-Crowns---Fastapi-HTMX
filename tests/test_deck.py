def test_init(deck):
    assert len(deck.cards) == 114  # 5 roles, each with 3 copies
    ...
    assert sum(1 for card in deck.cards if "joker" in card.suit.lower())==4
